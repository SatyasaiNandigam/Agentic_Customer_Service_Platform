...
| product_inquiry | Customer asks about a specific product's details, specs, or availability | "Does the blue jacket come in XL?" |
| product_search | Customer wants to browse or find products | "Show me wireless headphones under $50" |
| account_info | Customer asks about their profile, addresses, or account settings | "What address do you have for me?" |
| review_lookup | Customer wants to read reviews for a product | "What do people say about this laptop?" |
| faq_policy | Customer asks about store policies, shipping times, or general info | "What is your return policy?" |
| chitchat | Greeting, thanks, small talk, or off-topic conversation | "Hi!" / "Thanks, you've been helpful!" |
...
1. Pick the single most specific, actionable intent. When multiple apply, prefer the
   more actionable one: order_cancel beats complaint if both could fit.
...
_FEW_SHOT_EXAMPLES: list[tuple[str, dict]] = [
    ...
    # chitchat
    (
        "Hi! Thanks so much, you've been really helpful.",
        {"intent": "chitchat", "confidence": 0.99, "requires_tool": False, "needs_escalation": False},
    ),
